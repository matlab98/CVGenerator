...
public class GService : IGService
{
    ...
    public async Task<DefaultResponse> CVEnGenerator(DefaultRequest request)
    {
    ...
    public async Task<DefaultResponse> CVEsGenerator(DefaultRequest request)
    {
        MemoryStream ms = new MemoryStream();
        var reader = new PdfReader(pathTemplate);
        PdfWriter writer = new PdfWriter(ms);
        ...
        document.Add(sectionTitle("Acerca de mí"));
        document.Add(ls);
        document.Add(bodyInfo(request.description));

        document.Add(sectionTitle("Experiencia"));
        document.Add(ls);
        List<job> orderedList = request.jobs.OrderByDescending(o => o.endTime).ToList();
        foreach (job jobs in orderedList)
        {
            string time = FormatDateTime.MonthYear(jobs.startTime) + " - " + (jobs.isCurrently ? "Presente" : FormatDateTime.MonthYear(jobs.endTime));
            document.Add(startEnd(jobs.position + " | " + time));
            document.Add(historyTitle(jobs.enterprise, jobs.location));
            foreach (string activities in jobs.activities)
            {
        ...
        document.Add(sectionTitle("Educación"));
        document.Add(ls);
        ...
        document2.Add(sectionTitle("Contacto").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
        document2.Add(iconText("https://img.icons8.com/ios-filled/100/FFFFFF/google-pixel6.png", "", request.cel).SetFontColor(ColorConstants.WHITE));
        document2.Add(iconText("https://img.icons8.com/material-rounded/96/FFFFFF/place-marker.png", "", request.direction).SetFontColor(ColorConstants.WHITE));
        document2.Add(iconText("https://img.icons8.com/material-rounded/96/FFFFFF/mail.png", "", request.email).SetFontColor(ColorConstants.WHITE));
        ...
        document2.Add(sectionTitle("Habilidades").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
        ...
        document2.Add(sectionTitle("Idiomas").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
        ...
        document2.Add(sectionTitle("Fortalezas").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
        ...
        document2.Add(sectionTitle("Certificaciones").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
        ...
        document2.Add(sectionTitle("Reconocimientos").SetFontColor(ColorConstants.WHITE));
        document2.Add(ls2);
